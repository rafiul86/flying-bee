...
const Destination = () => {
    ...
    return (
            ...
            {userLocation.isVaid && <div> <img src="" alt=""/> <p style={{color : 'goldenrod' , fontWeight : '20px' }}>Thank you for choosing { userLocation.startLocation} the ride {userLocation.endLocation} . Your rider will contact you in seconds !</p> </div>}
